...
@Named
@ViewScoped
public class LancamentoCadastroBean implements Serializable{
...
//		lancamento = new Lancamento();
//		return "cadastro_lancamento.xhml?faces-redirect=true";
//	}
//	
//	public String prepararEdicao(Lancamento lancamento) {
